# -*- coding: utf-8 -*-
"""
Created on Tue May 14 22:17:59 2024
...
for file_obj in file_list:
    ...
    if file_obj.startswith ('df_full_data_genomeWNV_2373') & file_obj.endswith('.csv'):
        print (file_obj)
        csv_data = pd.read_csv(path + file_obj, index_col = 'seqID', encoding = 'gbk')
        print (csv_data.shape)
        seq_num = csv_data.shape[0]
        id_list = csv_data.index.tolist()
        ...
        for target_col in target_cols:
            ...
            df_NCR.to_csv ('df_full_counting_' + file_obj[3:-4] + '_' + target_col + '.csv')
